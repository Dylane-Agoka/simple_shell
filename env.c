...
/**
 * envFunction - prints the environment
 * @build: input build
 * Return: Always 1
 */
int envFunction(config *build)
{
	printList(build->env);
	return (1);
}
...
/**
 * setenvFunction - adds env variable if it does not exist;
 * modify env variable if it does
 * @build: input build
 * Return: Always 1
 */
int setenvFunction(config *build)
{
...
/**
 * unsetenvFunction - deletes env variable if exists;
 * will only accept valid variables names
 * @build: input build
 * Return: Always 1
 */
int unsetenvFunction(config *build)
{
